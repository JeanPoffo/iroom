...
public class AdicionarPostagemActivity extends AppCompatActivity implements BindDataView {
    ...
    public void bindDataToModel(Object entidade) {
        ...
        try {
            postagem.getQuarto().setQuantidadeQuarto(Integer.parseInt(this.getEditTextQuantidadeQuarto().getText().toString()));
        } catch(NullPointerException ex) {}

        try {
            postagem.getQuarto().setQuantidadeQuarto(Integer.parseInt(this.getEditTextQuantidadeSuite().getText().toString()));
        } catch(NullPointerException ex) {}
    }
